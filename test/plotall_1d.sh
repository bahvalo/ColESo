...
../plot1d.sh "plot 'simplewave.dat' using 1:2 w l ls 100 ti 'rho(t=0)', 'simplewave.dat' using 1:3 w l ls 102 ti 'p(t=0)', 'simplewave.dat' using 1:4 w l ls 104 ti 'rho(t=0.09)', 'simplewave.dat' using 1:5 w l ls 101 ti 'p(t=0.09)'" "x" "rho, p" simplewave.png
